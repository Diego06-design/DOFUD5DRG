 ...
 * @pre util_cadena_destino <= DIM_CADENA_DESTINO
 * @post El contenido de la cadena de destino será sobrescrito con lo que hubiera previamente
 * ------------------------------------------------------------*/

void imprimir_cadena(char cadena_destino, DIM_CADENA_DESTINO){
...
/** ------------------------------------------------------------
 * @brief Módulo que comprueba si la cadena está vacía
 * @param char cadena[] Cadena de la cual queremos comprobar si está vacía o no
 * @pre cadena != 0
 * @return bool Si está vacía o no lo está
 * ------------------------------------------------------------*/
